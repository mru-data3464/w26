...
## The task
For both this trial run and the real thing, I will provide you with a starting notebook and csv distributed through the "I" drive (hopefully it is ready in time). It will be a **familiar dataset**.

You will be asked to:

1. Load some data from a csv
2. Do a little bit of data exploration
3. Split into train/test 
4. Implement some components of a preprocessing pipeline, such as feature encoding or transformations
